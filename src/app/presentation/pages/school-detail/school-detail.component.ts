...
@Component({
    ...
    <div class="min-h-screen bg-gray-50 dark:bg-gray-950 pb-20 transition-colors duration-300">
      ...
      <!-- Content -->
      <div *ngIf="!loading() && school() as s" class="animate-in">
          ...
          <div class="relative h-[40vh] md:h-[50vh] bg-emerald-900 overflow-hidden">
               ...
               <div class="absolute bottom-0 left-0 right-0 p-6 md:p-12 max-w-7xl mx-auto">
                    <div class="flex flex-col md:flex-row md:items-end gap-6 justify-between">
                        ...
                        <a routerLink="/inscripcion" class="px-8 py-4 bg-white text-institutional hover:bg-emerald-50 rounded-2xl font-black shadow-xl transition-all active:scale-95 flex items-center gap-3 w-fit uppercase tracking-widest text-xs dark:bg-emerald-500 dark:text-white dark:hover:bg-emerald-400">
          ...
          <div class="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 lg:grid-cols-3 gap-12">
               ...
               <div class="lg:col-span-2 space-y-12">
                   <section class="space-y-6">
                       ...
                       <p class="text-gray-600 dark:text-gray-300 leading-relaxed text-lg">{{ s.description }}</p>
                   </section>
                   ...
                   <section class="space-y-6">
                       ...
                       <div class="flex flex-wrap gap-3">
                           <div *ngFor="let level of s.levels" class="px-6 py-4 bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-2xl shadow-sm flex items-center gap-3">
                               <div class="w-10 h-10 rounded-full bg-emerald-50 dark:bg-emerald-900/40 flex items-center justify-center text-institutional dark:text-emerald-400 font-bold text-lg hover:scale-110 transition-transform">
                                   {{ level[0] }}
                               </div>
                               <span class="font-bold text-gray-700 dark:text-gray-200">{{ level }}</span>
                           </div>
                       </div>
                   </section>
                   ...
                   <section class="space-y-6">
                       ...
                       <div class="bg-gray-200 rounded-3xl h-64 flex items-center justify-center text-gray-400 font-bold border-2 border-dashed border-gray-300">
                           <p>Mapa Interactivo (Stub: Lat {{ s.coordinates?.lat }}, Lng {{ s.coordinates?.lng }})</p>
                       </div>
                   </section>
               </div>
               ...
               <!-- Right Column: Stats -->
               <div class="space-y-6">
                   <div class="bg-white dark:bg-gray-900 p-8 rounded-[2.5rem] shadow-xl shadow-emerald-900/5 dark:shadow-emerald-900/20 border border-emerald-50 dark:border-gray-800 sticky top-24 space-y-8">
                        <div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex justify-between items-center">
                                <span class="text-sm font-bold text-gray-500">Turno</span>
                                <span class="text-sm font-black text-institutional text-right">Mañana / Tarde</span>
                            </div>
                            <div class="flex justify-between items-center">
                                <span class="text-sm font-bold text-gray-500">Tipo</span>
                                <span class="text-sm font-black text-institutional text-right">Fiscal / Convenio</span>
                            </div>
                        </div>
                        ...
                        <div class="pt-4">
                             ...
                             <button *ngIf="s.vacancies === 0" disabled class="w-full py-4 bg-gray-100 dark:bg-gray-800 text-gray-400 dark:text-gray-500 rounded-xl font-black uppercase text-xs tracking-widest cursor-not-allowed">
                                 Sin Cupos
                             </button>
                        </div>
                   </div>
